...
DEFAULT_COUNTRIES = OrderedDict([
    # --- القائمة المبدئية للدول الجديدة ---
    ("22501", "ساحل العاج"),
    ...
    # --- تستطيع إضافة ما تبقى من 200 دولة هنا عند الحاجة ---
])
...
COUNTRY_FLAGS = {
    ...
    "993": "🇹🇲", "994": "🇦🇿", "995": "🇬🇪", "996": "🇰🇬",
    "998": "🇺🇿",
    "22501": "🇨🇮", "22507": "🇨🇮", "23276": "🇸🇱", "26134": "🇲🇬",
    "44740": "🇬🇧", "23490": "🇳🇬", "25471": "🇰🇪", "24910": "🇸🇩",
    "49155": "🇩🇪", "23762": "🇨🇲", "22178": "🇸🇳", "22901": "🇧🇯",
    "22898": "🇹🇬",
}
...
# ══════════════════════════════════════════════════════════════════════════════
# التعديل النهائي لإزالة الاشتراك الإجباري (بدون حذف شيء)
# ══════════════════════════════════════════════════════════════════════════════
def check_subscription(uid):
    channels = db.get_channels()
    
    # تم إضافة هذا السطر فقط ليتم تخطي الفحص تماماً
    return True  
...
def countries_menu(service_key):
    """قائمة الدول لخدمة معينة (عمودية / زر فوق زر)"""
    countries = db.get_countries()
    markup = types.InlineKeyboardMarkup(row_width=1)  # تم تغيير 2 إلى 1 لجعل الأزرار عمودية
    buttons = []
    ...
    # إضافة الأزرار كصفوف منفردة (واحد تحت الآخر)
    for btn in buttons:
        markup.row(btn)
    
    # زر الرجوع للخدمات (عريض في الأسفل)
...
def show_home(cid, uid):
    ...
    # تم تعطيل فحص الاشتراك الإجباري نهائياً هنا
