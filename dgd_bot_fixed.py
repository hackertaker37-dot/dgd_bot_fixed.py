...
def start(message):
    ...
    if current_lang is None:
        ...
        mk.add(
            types.InlineKeyboardButton("🇸🇦 العربية", callback_data="set_lang_ar", style='success'),
            types.InlineKeyboardButton("🇬🇧 English", callback_data="set_lang_en", style='danger')
        )
...
def del_country_start(call):
    ...
    markup.add(types.InlineKeyboardButton("🔙 Back", callback_data="admin_back", style='primary'))
...
def force_sub_menu(call):
    ...
    markup.row(types.InlineKeyboardButton("➕ Add", callback_data="addch", style='primary'), types.InlineKeyboardButton("🔙 Back", callback_data="admin_back", style='primary'))
