...
# ══════════════════════════════════════════════════════════════════════════════
BOT_TOKEN = "8686995713:AAF63-X2bWOIO31O1CzkZ4gVm2gTv9XFprw"
...
DEFAULT_COUNTRIES = OrderedDict([
    # --- الدول الموجودة لديك مسبقاً (مُبقاة كما هي) ---
    ("22501", "ساحل العاج"),
    ...
    # --- جميع دول العالم (مرتبة أبجدياً بالعربية) ---
    ("93", "أفغانستان"),
    ("355", "ألبانيا"),
    ("49", "ألمانيا"), # مكرر لكن برمز دولي موحد (للاستخدام العام)
    ("213", "الجزائر"),
    ("376", "أندورا"),
    ("244", "أنغولا"),
    ("54", "الأرجنتين"),
    ...
    ("32", "بلجيكا"),
    ("501", "بليز"),
    ("229", "بنين"), # مكرر لكن برمز دولي موحد
    ("975", "بوتان"),
    ("591", "بوليفيا"),
    ("387", "البوسنة والهرسك"),
    ("267", "بوتسوانا"),
    ...
    ("257", "بوروندي"),
    ("855", "كمبوديا"),
    ("237", "الكاميرون"), # مكرر لكن برمز دولي موحد
    ("238", "الرأس الأخضر"),
    ...
    ("972", "إسرائيل"),
    ("39", "إيطاليا"),
    ("225", "ساحل العاج"), # مكرر لكن برمز دولي موحد
    ("81", "اليابان"),
    ("962", "الأردن"),
    ("7", "كازاخستان"),
    ("254", "كينيا"), # مكرر لكن برمز دولي موحد
    ("383", "كوسوفو"),
    ("965", "الكويت"),
    ("996", "قيرغيزستان"),
    ("856", "لاوس"),
    ...
    ("370", "ليتوانيا"),
    ("352", "لوكسمبورغ"),
    ("261", "مدغشقر"), # مكرر لكن برمز دولي موحد
    ("265", "ملاوي"),
    ("60", "ماليزيا"),
    ("960", "المالديف"),
    ("223", "مالي"),
    ...
    ("505", "نيكاراغوا"),
    ("227", "النيجر"),
    ("234", "نيجيريا"), # مكرر لكن برمز دولي موحد
    ("850", "كوريا الشمالية"),
    ...
    ("974", "قطر"),
    ("40", "رومانيا"),
    ("7", "روسيا"), # ملاحظة: روسيا وكازاخستان يشتركان في المفتاح "7" دولياً، قد تحتاج لتمييزه حسب سياق الاستخدام
    ("250", "رواندا"),
    ("685", "ساموا"),
    ("378", "سان مارينو"),
    ("239", "ساو تومي وبرينسيب"),
    ("966", "السعودية"),
    ("221", "السنغال"), # مكرر لكن برمز دولي موحد
    ("248", "سيشل"),
    ("232", "سيراليون"), # مكرر لكن برمز دولي موحد
    ("421", "سلوفاكيا"),
    ("386", "سلوفينيا"),
    ("677", "جزر سليمان"),
    ("252", "الصومال"),
    ...
    ("34", "إسبانيا"),
    ("94", "سريلانكا"),
    ("249", "السودان"), # مكرر لكن برمز دولي موحد
    ("597", "سورينام"),
    ("46", "السويد"),
    ("41", "سويسرا"),
    ("963", "سوريا"),
    ...
    ("66", "تايلاند"),
    ("670", "تيمور الشرقية"),
    ("228", "توجو"), # مكرر لكن برمز دولي موحد
    ("216", "تونس"),
    ("90", "تركيا"),
    ("993", "تركمانستان"),
    ("256", "أوغندا"),
    ...
    ("44", "المملكة المتحدة"), # مكرر لكن برمز دولي موحد
    ("1", "الولايات المتحدة"),
    ("598", "أوروغواي"),
    ("998", "أوزبكستان"),
    ("678", "فانواتو"),
